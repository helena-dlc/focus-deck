...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const loginView = document.getElementById('login-view'); // Elemento que contiene el mensaje de bienvenida y botón login
    const mainContent = document.getElementById('main-content'); // Contenedor principal de la app
